...
const Model = () => {
  ...
  // Camera Control
  /**
   * Small-Phone View Camera Controller
   */
  const cameraControlSmall = useRef()
  /**
   * Large-Phone View Camera Controller
   */
  const cameraControlLarge = useRef()

  /**
   * Small Phone ThreeJS Model
   */
  const small = useRef(new THREE.Group())
  /**
   * Large Phone ThreeJS Model
   */
        ...
        <div className="flex flex-col items-center mt-5">
          <div className="w-full h-[75vh] md:h-[90vh] overflow-hidden relative">
            <ModelView
              ...
              // From the current component state
              item={model}
              size={size}
            />
            <ModelView
